...
- `holder.stl` — отдельный держатель без опор с шипом "ласточкин хвост" и
  глухим каналом 12.6 мм под композитную арматуру 12 мм. Файл ориентирован
  для печати: глухой конец снизу, отверстие открыто вверх.
...
4. Напечатайте `holder.stl` отдельной деталью. Он уже ориентирован вертикально:
   глухой конец лежит на столе, канал под арматуру открыт вверх.
5. После печати разверните держатель как нужно для сборки и вставьте его в
   задний паз снизу. Закрытый верх паза работает как стопор; если посадка
   окажется свободной, можно добавить каплю клея.
